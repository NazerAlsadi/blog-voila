...
<!DOCTYPE html>
<html lang="{{ Session::get('applocale')}}" dir="{{ Session::get('applocale') == 'ar' ? 'rtl' : 'ltr' }}"> 
  <head>
    ...
    <link
      rel="icon"
      href="{{url('/')}}/admin/assets/img/kaiadmin/favicon.ico"
      type="image/x-icon"
    />
      ...
      <div class="sidebar" data-background-color="dark">
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="#" class="logo">
              <img
                src="{{url('/')}}/admin/assets/img/kaiadmin/logo_light.svg"
                alt="navbar brand"
                class="navbar-brand"
                height="20"
              />
            ...
            <ul class="nav nav-secondary">
              <li class="nav-item active">
                ...
                >
                  ...
                  <p>admin {{ Session::get('applocale') }}</p>
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <li class="nav-item topbar-icon dropdown hidden-caret">
                  ...
                  <ul
                    ...
                    aria-labelledby="messageDropdown" style="left: -100px; width: 100px; ">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="{{url('/')}}/admin/assets/img/profile.jpg"
                        alt="..."
